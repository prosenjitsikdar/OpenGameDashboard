...
import { metricRefundBetData, pendingBetsData, refundBetsData } from '../../data/mockData';
...
const RefundBet = () => {
  ...
  return (
    <div className="space-y-5 px-4 py-4">
      <div>
        <H1 text="Refund Bet" />
        <P text="Manage refunded. Use filters to find bets." />
      </div>
      <MetricsCards metrics={metricRefundBetData} className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8" />
