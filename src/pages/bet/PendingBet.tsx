...
import {metricPendingBetData, pendingBetsData } from '../../data/mockData';
  ...
  const [status, setStatus] = useState('');
    ...
    return (
        <div className="space-y-5 px-4 py-4">
            ...
            <MetricsCards metrics={metricPendingBetData} className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8" />
