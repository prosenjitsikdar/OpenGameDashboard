...
import {metricSettledBetData, settledBetsData, } from '../../data/mockData';
...
const SettledBet = () => {
    ...
    const uniqueSports = [...new Set(settledBetsData.map(bet => bet.sport))].sort();
    const uniqueEvents = [...new Set(settledBetsData.map(bet => bet.event))].sort();
    const uniqueMarkets = [...new Set(settledBetsData.map(bet => bet.market))].sort();
    const uniqueBetTypes = [...new Set(settledBetsData.map(bet => bet.betType))].sort();
    ...
    return (
        <div className="space-y-5 px-4 py-4">
            ...
            <MetricsCards metrics={metricSettledBetData} className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-8" />
